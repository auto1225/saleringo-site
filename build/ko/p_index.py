    ...
    <div class="reveal d60v2" data-d60 data-d60-script="../assets/demo/dental.json" data-d60-audio="../assets/audio/demo/">
      ...
      <div class="d60stage" id="d60stage" role="tabpanel">
        ...
        <div class="d60col">
          ...
          <div class="d60card d60morning" data-d60-morning hidden><p class="lbl">오전 9:00, 원장님 화면에 놓여 있는 것</p><div data-d60-morninglist></div></div>
        </div>
      </div>

      <p class="scenecap" data-d60-honest>각본이 있는 시연 · 예시 데이터 · 두 목소리는 이 데모를 위해 만든 합성 음성입니다 · 금액은 예시 요금표이며 실제 가격은 치과마다 다릅니다. 진짜 AI 음성은 <a data-tel-link href="tel:+827052770820">070-5277-0820</a>으로 들어 보세요.</p>
...
<section class="t-xl sec-light bg-paper" id="trades">
  <div class="wrap">
    ...
    <p class="sub reveal" style="max-width:none;">업종마다 다릅니다. 그래서 업종 페이지 예순다섯 곳마다
...
for _mod, _key in (('trades3', 'TRADES3'), ('trades4', 'TRADES4'), ('trades5', 'TRADES5'), ('trades6', 'TRADES6'), ('trades7', 'TRADES7')):
    try:
