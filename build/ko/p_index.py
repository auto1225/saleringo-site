  ...
  <div class="wrap">
    ...
    <div class="trio reveal" style="margin-top:34px;">
      <div><b>밤 11시 42분</b><p>문을 닫은 뒤에 걸려 온 전화입니다. 벨이 다섯 번 울리고
        끊깁니다. 다음 날 아침 부재중 목록에 번호 하나가 남지만, 누가 왜 걸었는지는
        알 수 없습니다. 다시 걸어도 대개 안 받습니다 &mdash; 그분은 이미 다른 곳에
        예약했습니다.</p></div>
      <div><b>점심시간 12시 40분</b><p>진료나 시술이 한창일 때입니다. 사람이 있어도
    ...
    <p class="seccap reveal" style="margin-top:20px;">이 셋의 공통점은
      ...
      안 보입니다. 그래서 줄이려는 시도조차 하지 않게 됩니다.</p>
  </div>
</section>
...
<section class="t-xl sec-light bg-paper" id="how">
  <div class="wrap">
    ...
    <div class="trio reveal" style="margin-top:34px;">
      <div><b>1 &middot; 받습니다</b><p>벨이 세 번 울리기 전에 받습니다. 밤이든 주말이든
        같고, 통화 중에 걸려 온 두 번째 전화도 동시에 받습니다. 번호는 쓰시던 것을
        그대로 두고 착신전환만 겁니다 &mdash; 명함도 간판도 안 바꾸십니다.</p></div>
      <div><b>2 &middot; 끝냅니다</b><p>등록해 두신 요금표로 금액을 안내하고, 캘린더의
        빈 시간을 보고 예약을 잡고, 확인 문자를 보냅니다.
        &ldquo;확인 후 연락드리겠습니다&rdquo;가 아니라 그 통화 안에서 끝납니다.</p></div>
      <div><b>3 &middot; 남깁니다</b><p>끊는 순간 고객 카드 한 장이 만들어져 있습니다.
        누가 왜 연락했는지, 무엇을 안내했는지, 다음에 무엇을 해야 하는지.
        아무도 타이핑하지 않았는데 항목이 차 있습니다.</p></div>
    </div>
...
<section class="t-xl sec-dark bg-spot" id="channels">
  <div class="wrap">
    ...
    <div class="kolist reveal" style="margin-top:30px;">
      <li><b>전화 &mdash; 가장 급한 문의가 옵니다</b>
        지금 당장 알아야 하는 사람이 겁니다. 그래서 놓쳤을 때 손실이 가장 큽니다.
        쓰시던 번호 그대로, 못 받을 때만 넘기거나 영업시간 밖에만 넘기실 수 있습니다.
    ...
    <p class="seccap reveal" style="margin-top:18px;">세 채널이 <b>한 수신함</b>으로 들어오고
      <b>한 장의 세금계산서</b>로 나갑니다. 채널마다 다른 도구를 쓰고 채널마다 따로
      청구되면, 어디서 얼마가 나가는지 아무도 모르게 됩니다.</p>
  </div>
</section>
...
<section class="t-xl sec-light2" id="crm">
  <div class="wrap">
    ...
    <div class="trio reveal" style="margin-top:34px;">
      <div><b>빈 화면에서 시작하지 않으십니다</b><p>일반 CRM 은 이름과 연락처를 묻고,
        나머지 항목은 사장님이 만들어 넣으셔야 합니다. 치과의 상담&rarr;검진&rarr;치료계획과
        정비소의 입고&rarr;견적&rarr;출고는 다릅니다. 그 단계를 업종별로 미리 만들어
        두었습니다.</p></div>
      <div><b>사람이 옮겨 적지 않습니다</b><p>대화가 끝나면 카드가 채워져 있습니다.
        녹취와 요약, 그리고 그 금액을 어느 요금표 줄에서 가져왔는지가 함께 붙습니다.
        나중에 &ldquo;그때 이렇게 들었는데요&rdquo; 하는 상황이 오면 열어 보실 수 있습니다.</p></div>
      <div><b>쌓이는 것은 사장님 것입니다</b><p>고객 기록, 통화 기록, 예약 내역을 언제든
        전부 내려받으십니다. 해지하실 때만이 아니라 쓰시는 동안 아무 때나. 반출비도
        받지 않습니다.</p></div>
    </div>
  </div>
</section>
...
<section class="t-xl sec-dark bg-dusk" id="plans">
  <div class="wrap">
    ...
    <p class="seccap reveal" style="margin-top:20px;">셋 다 같은 CRM 이 들어 있습니다.
      나뉘는 기준은 <b>어느 채널로 받는가</b>와 <b>한 달에 몇 건인가</b>입니다.
      약정이 없고, 요금제는 매달 올리거나 내리실 수 있습니다.
      첫 결제일부터 14일 안에는 전액 환불이고, 그 뒤에 해지하셔도 남은 날수는
      날짜로 계산해 돌려 드립니다. <a class="lnk" href="./pricing.html">요금 페이지</a>에
      한 달 청구서가 어떻게 생겼는지까지 적어 두었습니다.</p>
  </div>
</section>
