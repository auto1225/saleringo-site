...
('1. 이 방침이 다루는 것',
 ...
 '<p>두 번째에 대해서 회사는 <b>수탁자</b>입니다. 즉 그 정보의 개인정보처리자는 서비스를 이용하는 '
...
('2. 수집하는 항목과 목적',
 ...
 '</tbody></table></div>'
 '<p>주민등록번호는 수집하지 않습니다. 건강정보나 그 밖의 민감정보는 서비스 이용 사업자가 '
 '입력하지 않는 한 회사가 별도로 수집하지 않으며, 응대 과정에서 고객이 스스로 말한 내용이 '
 '녹음에 포함될 수 있다는 점은 아래 3항에서 다룹니다.</p>'),
...
('6. 정보주체의 권리',
 ...
 '</ul>'
 '<p>또한 「개인정보 보호법」 제37조의2에 따라, 완전히 자동화된 처리로 이루어진 결정에 대해 '
 '설명을 요구하거나 거부하실 수 있습니다. Saleringo의 응대는 예약을 잡고 안내를 하는 것에 그치며 '
 '권리 · 의무에 중대한 영향을 미치는 결정을 하지 않도록 설계되어 있으나, 그럼에도 설명을 요구하시면 '
 '해당 응대의 근거를 그대로 보여 드립니다.</p>'),
...
('제1조 (목적과 적용)',
 ...
 '<div class="caution"><b>이 문서에 대해 먼저 밝혀 둘 것.</b>'
...
('제2조 (서비스의 내용)',
 ...
 '그 내용을 고객관리 시스템에 기록하는 서비스를 제공합니다. 구체적인 응답 범위는 이용자가 '
 '등록한 요금표, 영업시간, 금지 사항에 따라 정해집니다.</p>'
 '<p>회사는 이용자가 등록하지 않은 정보를 근거로 응답하지 않도록 서비스를 설계합니다. '
 '다만 인공지능의 특성상 오류가 완전히 배제되지는 않으며, 이에 관하여는 제7조에서 정합니다.</p>'),
...
('제5조 (해지와 환불)',
 ...
 '<li>월 정액 요금은 해지 신청 시점의 결제 주기 잔여 기간에 대해 <b>일할 계산하여 환불</b>합니다. '
...
('제6조 (이용자의 의무)',
 ...
 '잘못 등록된 정보로 인해 고객에게 잘못된 안내가 나간 경우, 그 책임은 이용자에게 있습니다.</li>'
...
('사고가 났을 때',
 ...
 '해당 사업자에게 통지하고, 법령이 정하는 경우 개인정보보호위원회 또는 한국인터넷진흥원에 신고합니다.</p>'
