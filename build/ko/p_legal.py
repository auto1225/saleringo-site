...
('하고 있는 것',
 ...
 '<li><b>사업자 간 데이터 분리</b> &mdash; 운영 중인 표에는 데이터베이스 계층에서 '
 '사업자 식별자가 강제로 붙습니다(row-level security). 다른 가게의 자료가 조회되는 '
 '경로 자체를 만들지 않고, 배포할 때마다 교차 조회 시험을 돌립니다. '
 '예외가 둘 있습니다 &mdash; 되돌리기용으로 날짜를 찍어 떠 둔 마이그레이션 스냅숏과, '
 '어느 사업자의 것도 아닌 공통 참조 자료입니다. 앞의 것은 정리 중이고 뒤의 것은 '
 '나눌 것이 없습니다. 침투 시험에서 발견되게 두는 것보다 먼저 적습니다.</li>'
...
('데이터가 어디에 있는가',
 '<p>운영 서버와 데이터베이스는 <b>대한민국(서울)</b>에 있습니다. 고객 기록, 예약, 통화 녹취와 전사 기록이 여기 저장됩니다.</p><p>다만 <b>응대 문장을 만드는 언어모델은 미국에 있습니다.</b> 대화 내용이 답을 만들기 위해 그쪽으로 전송되고, 그것이 국외 이전입니다. 주문서에서 이 항목에 별도로 동의를 받는 이유가 그것입니다. 동의하지 않으시면 응대 생성 기능을 제공할 수 없고, 그것이 이 제품의 핵심이므로 사실상 이용이 어렵습니다. 계약 전에 먼저 말씀드립니다.</p><p>EU·미국·아시아 다른 지역에 별도 저장 지역이 필요하시면 계약으로 만들 수 있습니다. 지금 이미 있는 것처럼 적지 않습니다 &mdash; 현재 운영은 서울 한 곳입니다.</p><p>어느 회사가 이 데이터를 만지는지는 <a class="lnk" href="./privacy.html#transfer">처리방침 4항의 수탁업체 표</a>에 열 곳 전부 이름으로 적어 두었습니다.</p>'),
