...
('4. 처리 위탁과 국외 이전',
 '<p>서비스 제공을 위해 아래 업체에 개인정보 처리를 위탁하고 있으며, 상당수가 국외에 있습니다. '
 ...
 '</tbody></table></div>'
 '<p>대화 내용은 미국에 있는 서버에서 처리됩니다. 국외 이전에 동의하지 않으실 경우 '
 '응대 생성 기능을 제공할 수 없으며, 이는 서비스의 핵심이므로 사실상 이용이 어렵습니다. '
...
('제4조 (요금과 결제)',
 ...
 '<li><b>그 밖의 국가</b>에서는 회사가 해당 국가에 세무 등록을 두고 있지 않아 세금을 걷지 않으며, 세금 없는 인보이스를 발행합니다. 대리납부(reverse charge)가 적용되는 지역에서는 이용자가 자국에 직접 신고·납부합니다. 알려 주신 사업자번호는 인보이스에 기재됩니다.</li>'
...
doc('security.html', '보안',
    ...
    ids=['scope', 'measures', 'notyet', 'where', 'retention', 'incident',
