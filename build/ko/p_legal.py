...
('제5조 (해지와 환불)',
 ...
 '<li><b>첫 결제일부터 14일 안에는 전액 환불</b>합니다. 써 보시고 맞지 않으면 말씀만 해 주십시오. 이미 사용한 통화료 등 사용량 요금은 게시된 단가로 차감합니다.</li>'
 '<li>그 뒤에 해지하시는 경우, 월 정액 요금은 해지 신청일부터 그 달 남은 날수만큼 <b>날짜로 계산해 환불</b>합니다.</li>'
