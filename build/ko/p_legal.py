...
SUBPROC = (
 ...
 '<tr><td>Supabase Inc.</td><td>데이터베이스와 인증 &mdash; 데이터는 AWS 서울 리전(ap-northeast-2)</td><td>미국 법인 · 데이터 대한민국(서울)</td></tr>'
...
('제4조 (요금과 결제)',
 ...
 '<li><b>관리형(매니지드) 도입 상품</b>은 이 약관의 요금제와 별도인 상품으로, 이용자의 소재 국가와 관계없이 영문 요금 페이지에 게시된 미국 달러 금액으로 청구됩니다. 앞 항의 원화 청구는 이 상품에 적용되지 않으며, 구축비와 범위는 서면 견적으로 정합니다.</li>'
 ...
 '<li><b>창립 고객 할인.</b> 얼리액세스 기간에 가입하는 이용자는 요금제 게시 금액의 50%를 처음 3개월 동안 할인받습니다. 할인은 가입 시점에 확정되며, 그 3개월 안에 요금이 인상되어도 할인된 금액은 바뀌지 않습니다. 넉 달째부터는 게시 금액이 적용됩니다. 이 할인은 한 회차에 5팀으로 한정하며, 현재 회차의 모집 여부는 요금 페이지에 게시된 바에 따릅니다.</li>'
